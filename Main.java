...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("  Static | Package | Collections | If-Else");
        System.out.println("=".repeat(60));
        ...
        User user4 = new User(4, "",              "invalid-email",      "");  // invalid name + email
        ...
        Hotel hotel4 = new Hotel(104, "Invalid Hotel",       -50.00, 0, 6, false, false); // invalid price+stars
        ...
        Booking booking3 = new Booking(1003, user3, "2026-07-20", "2026-07-15",  500.00, BookingStatus.CONFIRMED); // bad dates
        Booking booking4 = new Booking(1001, user1, "2026-08-01", "2026-08-05",  400.00, BookingStatus.CONFIRMED); // duplicate ID
        ...
        repo.updateBookingStatus(9999, BookingStatus.CONFIRMED);  // not found

        // STEP 7: DISPLAY ALL DATA
        repo.displayAllData();

        // STEP 8: STATIC METHOD DEMO 
        System.out.println("\n" + "=".repeat(60));
        System.out.println("STATIC COUNTER DEMO");
        System.out.println("=".repeat(60));
        System.out.println("BookingRepository.getTotalBookingsCreated() = "
                + BookingRepository.getTotalBookingsCreated());
        System.out.println("-> This counter belongs to the CLASS, not any one object.");
        System.out.println("-> It tracks all valid bookings added since the program started.");

        // WEEK 3 SUMMARY
        System.out.println("\n" + "=".repeat(60));
        System.out.println("WEEK 3 OBJECTIVES COMPLETED");
        System.out.println("=".repeat(60));
        System.out.println("  1. PACKAGE (lowercase) : 'models' and 'repository'");
        System.out.println("  2. PRIVATE INNER CLASS : DataValidator inside BookingRepository");
        System.out.println("  3. IF-ELSE CONDITIONS  : Used in validation and duplicate checks");
        System.out.println("  4. COLLECTIONS         : ArrayList stores Users, Hotels, GuestHouses,");
        System.out.println("                           Apartments, and Bookings");
        System.out.println("  5. STATIC MEMBER       : totalBookingsCreated + getTotalBookingsCreated()");
        System.out.println("                           belongs to the class, shared across all objects");
